...
If `CONVENTIONS.md` and `STANDARDS.md` are present in this directory, read them before changing this dbt project. `CONVENTIONS.md` holds business rules. `STANDARDS.md` defines how models and tests are built here.
